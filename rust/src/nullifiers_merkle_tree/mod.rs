...
mod tests {
    ...
    use crate::nullifiers_merkle_tree::helpers::{
        convert_vec_u32_into_vec_u8, hash_to_bytes, to_ethers_hash, to_ethers_hash_bytes,
        to_ethers_nullifier,
    };
    ...
    //         .into();
    //
    //     let res_u8 = convert_vec_u32_into_vec_u8(res_u64);
    //
    //     assert_eq!(res_u8, hash_bytes);
    // }
    //
    ...
    //         .into();
    //
    //     let res_u8_branch_hash = convert_vec_u32_into_vec_u8(res_u64_branch_hash);
    //
    ...
    //         convert_vec_u32_into_vec_u8(res_u64_branch_hash_with_updates);
    //
    ...
    //         .into();
    //
    //     assert_eq!(convert_vec_u32_into_vec_u8(res), hash_to_bytes(&rust_value));
    // }
    //
    // #[tokio::test]
