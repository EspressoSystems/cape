...
mod tests {
    ...
    use crate::{
        ethereum, to_ethers,
        types::{G1Point, TestTranscript, TranscriptData},
        G1Ark,
    };
    use ark_ff::Zero;
    ...
    async fn test_append_empty() {
        ...
        let ret = contract
            ...
            .await
            .unwrap();
        assert_eq!(ret, to_ethers(challenge));
    }
        ...
        for _test in 0..10 {
            ...
            let ret = contract
                .test_append_challenge_and_get(
                    ...
                    to_ethers(first_challenge),
                )
                .call()
                .await
                .unwrap();

            assert_eq!(ret, to_ethers(final_challenge));
        }
    }
    ...
    async fn test_get_and_append_challenge_multiple_times() {
        ...
        for _test in 0..10 {
            ...
            let ret = contract
                .test_get_and_append_challenge_multiple_times(
                    TranscriptData::default(),
                    times.into(),
                )
                .call()
    ...
    async fn test_append_commitment() {
        ...
        for _test in 0..10 {
            ...
            let ethers_commitment: G1Point = G1Ark(g1_point).into();
            transcript
    ...
    async fn test_append_commitments() {
        ...
        for _test in 0..10 {
            ...
            let ethers_comms: Vec<G1Point> = points.iter().map(|&p| G1Ark(p).into()).collect();
    ...
    async fn test_infinity_commitment() {
        ...
        let ethers_commitment: G1Point = G1Ark(g1_zero).into();
        transcript
            .append_commitments::<E, G1>(b"ignored", &[commitment])
            .unwrap();
