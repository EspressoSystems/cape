...
async function main() {
  ...
  await print_report(owner, "NO Merkle tree update", fun_to_eval, fun_names, chunk, false);

  await print_report(owner, "Merkle tree update", fun_to_eval, fun_names, chunk, true);
}
