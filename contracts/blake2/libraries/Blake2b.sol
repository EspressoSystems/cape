...
library Blake2b {
    function digest208(bytes memory input208)
        internal
        view
        returns (bytes32 ret)
    {
        ...
        assembly {
            ...
            mstore(
                memory_ptr,
                0x0000000c28c9bdf267e6096a3ba7ca8485ae67bb2bf894fe72f36e3cf1361d5f
            )
            mstore(
                add(memory_ptr, 0x20),
                0x3af54fa5d182e6ad7f520e511f6c3e2b8c68059b08d623d6cfbce57e0c4d0a3e
            )
            mstore(
                add(memory_ptr, 0x40),
                0x71ac933300000000000000000000000000000000000000000000000000000000
            )
            mstore(
                add(memory_ptr, 0x60),
    ...
    function digest208Ptr(uint256 input_ptr)
        internal
        view
        returns (bytes32 ret)
    {
    ...
    function digest64(bytes memory input64)
        internal
        view
        returns (bytes32 ret)
    {
    ...
    function digest64Merge(bytes32 left, bytes32 right)
        internal
        view
        returns (bytes32 ret)
    {
